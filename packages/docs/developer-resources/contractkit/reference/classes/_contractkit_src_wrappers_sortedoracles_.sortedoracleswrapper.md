...
\+ **new SortedOraclesWrapper**(`kit`: [ContractKit](_contractkit_src_kit_.contractkit.md), `contract`: SortedOracles): *[SortedOraclesWrapper](_contractkit_src_wrappers_sortedoracles_.sortedoracleswrapper.md)*
